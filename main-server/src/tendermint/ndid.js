...
export async function allowYourDataServiceToBeMixedInRequest(
  ...
  try {
    await tendermint.transact({
      nodeId,
      fnName: 'AllowYourDataServiceToBeMixedInRequest',
      params: {},
      callbackFnName,
      callbackAdditionalArgs,
      saveForRetryOnChainDisabled,
    ...
    throw new CustomError({
      message: 'Cannot allow YourData service to be mixed in request',
      cause: error,
    });
  }
}
...
export async function disallowYourDataServiceToBeMixedInRequest(
  ...
  try {
    await tendermint.transact({
      nodeId,
      fnName: 'DisallowYourDataServiceToBeMixedInRequest',
      params: {},
      callbackFnName,
      callbackAdditionalArgs,
      saveForRetryOnChainDisabled,
    ...
    throw new CustomError({
      message: 'Cannot disallow YourData service to be mixed in request',
      cause: error,
    });
  }
}
