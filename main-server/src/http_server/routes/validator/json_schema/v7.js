...
export default {
  ...
  POST: {
    ...
    '/yourdata/as/service/:service_id': {
      body: {
        type: 'object',
        properties: {
          node_id: { type: 'string', minLength: 1 },
    ...
    '/yourdata/utility/token': {
      body: {
        ...
        properties: {
          ...
          namespace: { type: 'string', minLength: 1 },
          identifier: { type: 'string', minLength: 1 },
          token_objective: { type: 'string', minLength: 1 },
          sub_identity_list: {
            type: 'array',
            items: {
              type: 'object',
          ...
          validate_identifier: { type: 'boolean' },
          validate_service_id: { type: 'boolean' },
          validate_service_extension: { type: 'boolean' },
          usage_type: {
            type: 'string',
            enum: [
              'one_time',
