...
- `DEFAULT_API_VERSION`: API version to serve on default path (without version path prefix) [Default: `7`]
- `CALLBACK_API_VERSION`: Callback API version [Default: `7`]
...
- `LOG_REDACT_SENSITIVE_DATA`: Redact or mask sensitive data in logs [Default: `false`]
...
- `HTTP_REQUEST_BODY_SIZE_LIMIT`: Maximum HTTP request body size (in bytes) [Default: `26214400` (25 x 1024 x 1024 = 25MB)]
