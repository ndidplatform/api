...
SERVER_PORT=50000 \
MQ_RECV_SERVICE_SERVER_PORT=12001 \
node build/server.js &

NODE_ID=idp2 \
MQ_BINDING_PORT=5001 \
SERVER_PORT=50001 \
MQ_RECV_SERVICE_SERVER_PORT=12002 \
node build/server.js &

NODE_ID=idp3 \
MQ_BINDING_PORT=5002 \
SERVER_PORT=50002 \
MQ_RECV_SERVICE_SERVER_PORT=12003 \
node build/server.js &

NODE_ID=rp1 \
MQ_BINDING_PORT=5100 \
SERVER_PORT=51000 \
MQ_RECV_SERVICE_SERVER_PORT=13001 \
node build/server.js &

NODE_ID=rp2 \
MQ_BINDING_PORT=5101 \
SERVER_PORT=51001 \
MQ_RECV_SERVICE_SERVER_PORT=13002 \
node build/server.js &

NODE_ID=as1 \
MQ_BINDING_PORT=5200 \
SERVER_PORT=52000 \
MQ_RECV_SERVICE_SERVER_PORT=14001 \
node build/server.js &

NODE_ID=as2 \
MQ_BINDING_PORT=5201 \
SERVER_PORT=52001 \
MQ_RECV_SERVICE_SERVER_PORT=14002 \
node build/server.js &

NODE_ID=proxy1 \
MQ_BINDING_PORT=5300 \
SERVER_PORT=53000 \
MQ_RECV_SERVICE_SERVER_PORT=15001 \
node build/server.js &

NODE_ID=proxy2 \
MQ_BINDING_PORT=5301 \
SERVER_PORT=53001 \
MQ_RECV_SERVICE_SERVER_PORT=15002 \
node build/server.js &
...
MQ_RECV_GRPC_SERVER_PORT=12001 \
node build/server.js &
...
ENABLE_CONFIG_HTTP_ROUTE_PATH=true \
ENABLE_TELEMETRY_LOGGING=true \
MQ_RECV_GRPC_SERVER_PORT=12002 \
node build/server.js &
...
ENABLE_CONFIG_HTTP_ROUTE_PATH=true \
ENABLE_TELEMETRY_LOGGING=true \
MQ_RECV_GRPC_SERVER_PORT=12003 \
node build/server.js &
...
ENABLE_CONFIG_HTTP_ROUTE_PATH=true \
ENABLE_TELEMETRY_LOGGING=true \
MQ_RECV_GRPC_SERVER_PORT=13001 \
node build/server.js &
...
ENABLE_CONFIG_HTTP_ROUTE_PATH=true \
ENABLE_TELEMETRY_LOGGING=true \
MQ_RECV_GRPC_SERVER_PORT=13002 \
node build/server.js &
...
ENABLE_CONFIG_HTTP_ROUTE_PATH=true \
ENABLE_TELEMETRY_LOGGING=true \
MQ_RECV_GRPC_SERVER_PORT=14001 \
node build/server.js &
...
ENABLE_CONFIG_HTTP_ROUTE_PATH=true \
ENABLE_TELEMETRY_LOGGING=true \
MQ_RECV_GRPC_SERVER_PORT=14002 \
node build/server.js &
...
ENABLE_CONFIG_HTTP_ROUTE_PATH=true \
ENABLE_TELEMETRY_LOGGING=true \
MQ_RECV_GRPC_SERVER_PORT=15001 \
node build/server.js &
...
ENABLE_CONFIG_HTTP_ROUTE_PATH=true \
ENABLE_TELEMETRY_LOGGING=true \
MQ_RECV_GRPC_SERVER_PORT=15002 \
node build/server.js &
