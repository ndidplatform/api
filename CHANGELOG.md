...
- API v3.1
  ...
  - New API: GET `/idp/request_message_padded_hash` for getting `request_message_padded_hash` used for mode 2 and 3 request signature (signed with accessor private key without padding) on response.
